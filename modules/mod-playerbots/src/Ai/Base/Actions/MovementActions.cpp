...
void MovementAction::DoMovePoint(Unit* unit, float x, float y, float z, bool generatePath, bool backwards)
{
    ...
    else
    {
        mm->MovePoint(
            /*id*/ 0,
            /*coords*/ x, y, z,
            /*forcedMovement*/ FORCED_MOVEMENT_RUN, // CONQUEST PATCH — force run (vs default NONE)
            /*speed*/ 0.f,
            /*orientation*/ 0.f,
            /*generatePath*/ generatePath,
            /*forceDestination*/ true);             // CONQUEST PATCH — force le movement même si navmesh imparfait
    }
}
