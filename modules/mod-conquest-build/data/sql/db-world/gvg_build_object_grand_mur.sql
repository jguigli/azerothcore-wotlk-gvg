-- Conquest Build Module - Grand Mur GameObject Configuration
-- Crée le GameObject 400020 (Grand Mur) basé sur 190397

-- =====================================================
-- Création du GRAND MUR (GameObject 400020)
-- Basé sur l'entry 190397
-- =====================================================

-- Supprimer si existe
DELETE FROM `gameobject_template` WHERE `entry` = 400020;

-- Créer le grand mur basé sur le game object 190397
INSERT INTO `gameobject_template` 
SELECT 
    400020,                                 -- Entry du grand mur Conquest
    type,                                   -- Type 33 (GAMEOBJECT_TYPE_DESTRUCTIBLE_BUILDING)
    displayId,                              -- DisplayId du game object 190397
    'Grand Mur Conquest',                        -- Nom
    IconName,
    castBarCaption,
    unk1,
    size,
    ...
    AIName,
    'go_conquest_build_structure',              -- Script custom pour le grand mur
    VerifiedBuild
FROM `gameobject_template` 
WHERE `entry` = 190397;

-- Configuration du grand mur comme destructible
UPDATE `gameobject_template` SET 
    ...
    `Data0` = 700000,                       -- IntactNumHits (PV à l'état intact)
...
-- Vérification
SELECT CONCAT('GameObject Grand Mur 400020 configuré avec 700000 PV.') AS Result;
