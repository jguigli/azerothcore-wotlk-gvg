-- Conquest Build Module - Batiment 2 GameObject Configuration
-- Crée le GameObject 400029 (Batiment 2 Conquest) basé sur 190373

-- =====================================================
-- Création du BATIMENT 2 Conquest (GameObject 400029)
-- Basé sur l'entry 190373
-- =====================================================

-- Supprimer si existe
DELETE FROM `gameobject_template` WHERE `entry` = 400029;

-- Créer le batiment 2 basé sur le game object 190373
INSERT INTO `gameobject_template` 
SELECT 
    400029,                                 -- Entry du batiment 2 Conquest
    type,                                   -- Type du game object source
    displayId,                              -- DisplayId du game object 190373
    'Batiment 2 Conquest',                       -- Nom
    IconName,
    castBarCaption,
    unk1,
    size,
    ...
    AIName,
    'go_conquest_build_structure',              -- Script custom pour le batiment 2
    VerifiedBuild
FROM `gameobject_template` 
WHERE `entry` = 190373;

-- Configuration du batiment 2 comme destructible
...
-- Vérification
SELECT CONCAT('GameObject Batiment 2 400029 configuré avec 250000 PV.') AS Result;
