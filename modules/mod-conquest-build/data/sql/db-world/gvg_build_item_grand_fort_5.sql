-- Conquest Build Module - Item Configuration pour Grand Fort 5
-- Creates build item: Kit de grand fort 5 (80014)

-- Delete existing item
DELETE FROM `item_template` WHERE `entry` = 80014;

-- Kit de grand fort 5 (80014)
...
-- Informations
SELECT 'Kit de grand fort 5 créé avec succès!' AS Result;
SELECT 'Item ID: 80014 - Kit de grand fort 5 (Rareté 5)' AS Info;
SELECT 'Utilisez .additem 80014' AS Command;
