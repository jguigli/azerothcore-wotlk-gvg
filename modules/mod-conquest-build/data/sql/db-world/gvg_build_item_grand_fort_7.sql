-- Conquest Build Module - Item Configuration pour Grand Fort 7
-- Creates build item: Kit de grand fort 7 (80016)

-- Delete existing item
DELETE FROM `item_template` WHERE `entry` = 80016;

-- Kit de grand fort 7 (80016)
...
-- Informations
SELECT 'Kit de grand fort 7 créé avec succès!' AS Result;
SELECT 'Item ID: 80016 - Kit de grand fort 7 (Rareté 5)' AS Info;
SELECT 'Utilisez .additem 80016' AS Command;
