-- Conquest Build Module - Grande Tour GameObject Configuration
-- Crée le GameObject 400021 (Grande Tour) basé sur 190398

-- =====================================================
-- Création de la GRANDE TOUR (GameObject 400021)
-- Basé sur l'entry 190398
-- =====================================================

-- Supprimer si existe
DELETE FROM `gameobject_template` WHERE `entry` = 400021;

-- Créer la grande tour basée sur le game object 190398
INSERT INTO `gameobject_template` 
SELECT 
    400021,                                 -- Entry de la grande tour Conquest
    type,                                   -- Type 33 (GAMEOBJECT_TYPE_DESTRUCTIBLE_BUILDING)
    displayId,                              -- DisplayId du game object 190398
    'Grande Tour Conquest',                      -- Nom
    IconName,
    castBarCaption,
    unk1,
    size,
    ...
    AIName,
    'go_conquest_build_structure',              -- Script custom pour la grande tour
    VerifiedBuild
FROM `gameobject_template` 
WHERE `entry` = 190398;

-- Configuration de la grande tour comme destructible
UPDATE `gameobject_template` SET 
    ...
    `Data0` = 800000,                       -- IntactNumHits (PV à l'état intact - Tour plus résistante)
...
-- Vérification
SELECT CONCAT('GameObject Grande Tour 400021 configuré avec 800000 PV.') AS Result;

-- =====================================================
-- INFORMATIONS
-- =====================================================
-- Type 33 = GAMEOBJECT_TYPE_DESTRUCTIBLE_BUILDING
-- Comme les murs et tours du Joug-d'Hiver
-- Peuvent être attaqués par des engins de siège
